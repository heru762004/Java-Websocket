...
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable, WebSocket {
	...
	public WebSocketClient( URI serverUri , Draft draft ) {
		this( serverUri, draft, null, 5000 );
	}
	...
	public void run() {
		...
		Thread pingThread = new Thread( new WebsocketPingThread() );
		pingThread.start();
	...
	private class WebsocketPingThread implements Runnable {

		@Override
		public void run() {
			Thread.currentThread().setName( "WebsocketPingThread" );
			engine.pingProcess();
			engine.eot();
		}
